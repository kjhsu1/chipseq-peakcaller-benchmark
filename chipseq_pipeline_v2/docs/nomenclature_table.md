...
| `balanced_tfclean_realistic_plateaus_wavy_broad_integrated_288` | `wavy_plateau_broad` | plateau-like | wavy | broad |
| `balanced_tfclean_realistic_plateaus_hilly_broad_integrated_288` | `hilly_plateau_broad` | plateau-like | hilly / hotspot-dense | broad |
