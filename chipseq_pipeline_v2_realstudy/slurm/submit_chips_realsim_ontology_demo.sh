...
SBATCH_SCRIPT="${SBATCH_SCRIPT:-slurm/chips_realsim_ontology_demo.sbatch}"
RUN_TS="$(date +%Y%m%d_%H%M%S)"
STAGED_REPO="${STAGE_ROOT}/chips_realsim_ontology_demo_submit_${RUN_TS}"
...
echo "Submitted ChIPs realstudy ontology demo workflow as ${job_id}"
