...
rule evaluate_chips_ontology:
    ...
    output:
        ...
        control_response_png="analysis_outputs/chips_ontology/summary/control_response_by_ontology.png",
        failure_modes="analysis_outputs/chips_ontology/summary/failure_mode_metrics.csv",
        coverage_csv="analysis_outputs/chips_ontology/summary/ontology_class_coverage.csv",
