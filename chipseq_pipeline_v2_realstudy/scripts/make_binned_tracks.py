"""Build simple multi-contig binned coverage tracks from BAM files."""
            ...
            rows.append(
                {
                    ...
                    "log2_treat_control": float(
                        np.log2((treat_mean + args.pseudocount) / (control_mean + args.pseudocount))
                    ),
                }
            )
        ...
        json.dumps(
            {
                ...
                "contig_count": len(references),
                "language": "reference / estimated, not true",
            },
            indent=2,
        ),
        encoding="utf-8",
