# Chipseq Pipeline Guidelines

This file governs contributions within `for_testing_chipseq_pipeline`. Follow
...
## Documentation
- Update the `README.md` whenever a PR requires changes to its content.
